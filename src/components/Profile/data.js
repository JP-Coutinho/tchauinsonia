...
export const instructions = [
    ...
    },
    {
        ...
        shortDescription: 'Experimente exercícios de respiração para reduzir a ansiedade antes de dormir.',
        description:'',
        video: 'https://www.youtube.com/embed/fSt2lndHImQ?si=OmdYyO1Wz0GcEse6',
        pdf: '/rbn-533-3-transtornos-do-sono-1-2.pdf',
        finished: 1,
    },
    {
      title: 'Monitoramento do Sono',
      shortDescription: 'Use o diário do sono no aplicativo para acompanhar seu progresso.',
      description: '',
      video: 'https://www.youtube.com/embed/fSt2lndHImQ?si=OmdYyO1Wz0GcEse6',
      pdf: '/rbn-533-3-transtornos-do-sono-1-2.pdf',
      finished: 0,
...
export const formResponsesMock = [
  {
    id: 1,
    title: "Formulário de Questionário de Sono 1",
    shortDescription: "Questões sobre padrões de sono e hábitos noturnos.",
    questions: [
      { question: "Você tem dificuldade para dormir à noite?", answer: "Sim, frequentemente." },
      { question: "Quanto tempo você demora para adormecer?", answer: "30 minutos em média." },
      { question: "Você sente cansaço durante o dia?", answer: "Sim, frequentemente." },
      { question: "Você acorda várias vezes durante a noite?", answer: "Sim, algumas vezes." },
      { question: "Você consome cafeína à tarde ou noite?", answer: "Sim, frequentemente." },
      { question: "Você tem hábitos relaxantes antes de dormir?", answer: "Sim, leitura leve ou meditação." },
      { question: "Você utiliza dispositivos eletrônicos antes de dormir?", answer: "Sim, frequentemente." },
      { question: "Você sente que o ambiente do quarto é adequado para dormir?", answer: "Não, pode ser melhor." },
      { question: "Você pratica exercícios físicos durante o dia?", answer: "Sim, regularmente." },
      { question: "Você já experimentou técnicas de higiene do sono?", answer: "Sim, mas sem resultados significativos." }
    ],
    medicalObservation: "<h2>Orientações para Melhorar o Sono</h2> <ul> <li><strong>Evite Cafeína à Noite:</strong> Reduza ou elimine o consumo de cafeína no final da tarde e à noite, pois ela pode interferir no seu sono.</li> <li><strong>Estabeleça uma Rotina de Sono:</strong> Tente ir para a cama e acordar no mesmo horário todos os dias para regular seu ciclo de sono.</li> <li><strong>Crie um Ambiente Propício para Dormir:</strong> Certifique-se de que seu quarto está escuro, silencioso e a uma temperatura confortável. Considere o uso de máscaras de dormir ou tampões de ouvido se necessário.</li> <li><strong>Limite o Uso de Dispositivos Eletrônicos:</strong> Evite o uso de dispositivos eletrônicos pelo menos uma hora antes de dormir. A luz azul emitida por essas telas pode atrapalhar a produção de melatonina.</li> <li><strong>Pratique Técnicas de Relaxamento:</strong> Continue com práticas de leitura leve ou meditação antes de dormir para ajudar seu corpo a relaxar.</li> <li><strong>Considere Consultar um Especialista:</strong> Se as dificuldades persistirem, pode ser útil consultar um especialista em sono para orientação adicional.</li> </ul> <h2>Conclusão</h2> <p>Implementar essas mudanças pode levar algum tempo, mas persistir com elas pode melhorar significativamente a qualidade do seu sono.</p>",
    video: 'https://www.youtube.com/embed/fzYdk1zIpPo?si=5qj7B1w_Vwrw8iK7',
  },
  {
    id: 2,
    title: "Formulário de Questionário de Sono 2",
    shortDescription: "Avaliação de qualidade de sono e bem-estar geral.",
    questions: [
      { question: "Você acorda várias vezes durante a noite?", answer: "Sim, várias vezes." },
      { question: "Você sente sonolência durante o dia?", answer: "Sim, frequentemente." },
      { question: "Você tem hábitos relaxantes antes de dormir?", answer: "Sim, mas sem efeito significativo." },
      { question: "Você consome álcool à noite?", answer: "Sim, ocasionalmente." },
      { question: "Você acorda sentindo cansaço ou não descansado?", answer: "Sim, frequentemente." },
      { question: "Você tem alguma rotina para dormir bem?", answer: "Não, falha em manter uma rotina consistente." },
      { question: "Você utiliza técnicas de higiene do sono?", answer: "Sim, mas sem sucesso contínuo." },
      { question: "Você sente que seu ambiente noturno está tranquilo?", answer: "Não, pode ser melhor." },
      { question: "Você experimenta estresse ou ansiedade à noite?", answer: "Sim, frequentemente." },
      { question: "Você pratica atividades físicas durante o dia?", answer: "Sim, ocasionalmente." }
    ],
    medicalObservation: "<h2>Orientações para Melhorar o Sono</h2> <ul> <li><strong>Evite Consumo de Álcool à Noite:</strong> O álcool pode atrapalhar o sono, causando despertares noturnos. Tente reduzir ou eliminar o consumo de álcool à noite.</li> <li><strong>Estabeleça uma Rotina de Sono:</strong> Tente ir para a cama e acordar no mesmo horário todos os dias para regular seu ciclo de sono e melhorar a consistência.</li> <li><strong>Crie um Ambiente Propício para Dormir:</strong> Certifique-se de que seu quarto está escuro, silencioso e a uma temperatura confortável. Considere o uso de máscaras de dormir, tampões de ouvido ou máquinas de ruído branco.</li> <li><strong>Limite o Uso de Dispositivos Eletrônicos:</strong> Evite o uso de dispositivos eletrônicos pelo menos uma hora antes de dormir, pois a luz azul emitida por essas telas pode atrapalhar a produção de melatonina.</li> <li><strong>Pratique Técnicas de Relaxamento:</strong> Continue com práticas de leitura leve ou meditação antes de dormir, mas experimente outras técnicas de relaxamento, como respiração profunda ou alongamento leve.</li> <li><strong>Gerencie o Estresse e a Ansiedade:</strong> Considere técnicas de gerenciamento de estresse, como a prática de yoga, mindfulness ou conversar com um terapeuta.</li> <li><strong>Aumente a Atividade Física:</strong> Tente fazer exercícios regularmente durante o dia, pois a atividade física pode melhorar a qualidade do sono.</li> <li><strong>Considere Consultar um Especialista:</strong> Se as dificuldades persistirem, pode ser útil consultar um especialista em sono para orientação adicional e técnicas avançadas de higiene do sono.</li> </ul> <h2>Conclusão</h2> <p>Implementar essas mudanças pode levar algum tempo, mas persistir com elas pode melhorar significativamente a qualidade do seu sono e seu bem-estar geral.</p>",
    video: 'https://www.youtube.com/embed/fzYdk1zIpPo?si=5qj7B1w_Vwrw8iK7',
  },
  {
    id: 3,
    title: "Formulário de Questionário de Sono 3",
    shortDescription: "Análise mais detalhada dos hábitos de sono.",
    questions: [
      { question: "Você utiliza dispositivos eletrônicos antes de dormir?", answer: "Sim, frequentemente." },
      { question: "Você sente que o ambiente do quarto é propício para o sono?", answer: "Não, o ambiente pode ser melhor." },
      { question: "Você consome cafeína ou álcool à noite?", answer: "Sim, frequentemente." },
      { question: "Você pratica atividades físicas à noite?", answer: "Não, geralmente à tarde." },
      { question: "Você sente dificuldade em manter um sono contínuo?", answer: "Sim, frequentemente." },
      { question: "Você já experimentou técnicas de relaxamento?", answer: "Sim, mas sem sucesso consistente." },
      { question: "Você sente que seu ambiente noturno contribui para o sono?", answer: "Não, pode ser ajustado." },
      { question: "Você sente que está ansioso antes de dormir?", answer: "Sim, frequentemente." },
      { question: "Você tem uma rotina clara de relaxamento antes de dormir?", answer: "Não, falha em implementar." },
      { question: "Você já buscou ajuda profissional para o sono?", answer: "Sim, mas sem efeitos duradouros." }
    ],
    medicalObservation: "<h2>Orientações para Melhorar o Sono</h2> <ul> <li><strong>Evite o Uso de Dispositivos Eletrônicos:</strong> Tente evitar o uso de dispositivos eletrônicos pelo menos uma hora antes de dormir, pois a luz azul emitida por essas telas pode interferir na produção de melatonina.</li> <li><strong>Melhore o Ambiente do Quarto:</strong> Certifique-se de que seu quarto está escuro, silencioso e a uma temperatura confortável. Pode ser útil usar cortinas blackout, tampões de ouvido ou uma máquina de ruído branco.</li> <li><strong>Reduza o Consumo de Cafeína e Álcool:</strong> Evite consumir cafeína e álcool no final da tarde e à noite, pois ambos podem interferir na qualidade do sono.</li> <li><strong>Pratique Exercícios Físicos Regulares:</strong> Continue praticando exercícios, mas prefira fazê-los mais cedo durante o dia para não interferir no sono noturno.</li> <li><strong>Estabeleça uma Rotina de Relaxamento:</strong> Tente estabelecer uma rotina clara de relaxamento antes de dormir, como tomar um banho quente, ler um livro ou praticar meditação.</li> <li><strong>Ajuste seu Ambiente Noturno:</strong> Faça ajustes no ambiente do seu quarto para torná-lo mais propício ao sono. Isso pode incluir ajustar a iluminação, a temperatura e minimizar ruídos.</li> <li><strong>Gerencie a Ansiedade:</strong> Considere técnicas para gerenciar a ansiedade, como a prática de mindfulness, yoga ou terapia.</li> <li><strong>Considere Ajuda Profissional:</strong> Se as dificuldades persistirem, pode ser útil buscar ajuda de um especialista em sono para orientação adicional e técnicas avançadas de higiene do sono.</li> </ul> <h2>Conclusão</h2> <p>Implementar essas mudanças pode levar algum tempo, mas persistir com elas pode melhorar significativamente a qualidade do seu sono e seu bem-estar geral.</p>",
    video: 'https://www.youtube.com/embed/fzYdk1zIpPo?si=5qj7B1w_Vwrw8iK7',
  },
  // Adicionei mais dois exemplos de formulários para ilustrar o modelo com 10 questões cada.
  {
    id: 4,
    title: "Formulário de Questionário de Sono 4",
    shortDescription: "Avaliação detalhada de padrões de sono e higiene do sono.",
    questions: [
      { question: "Você acorda frequentemente durante a noite?", answer: "Sim, frequentemente." },
      { question: "Você tem dificuldade em adormecer novamente após acordar?", answer: "Sim, frequentemente." },
      { question: "Você consome cafeína em excesso à noite?", answer: "Sim, frequentemente." },
      { question: "Você utiliza medicações para dormir?", answer: "Não, evito." },
      { question: "Você se sente cansado ao acordar?", answer: "Sim, frequentemente." },
      { question: "Você tem rotina relaxante antes de dormir?", answer: "Sim, leitura leve e relaxamento." },
      { question: "Você utiliza técnicas de meditação ou respiração?", answer: "Sim, esporadicamente." },
      { question: "Você tem um ambiente propício para o sono?", answer: "Não, a iluminação pode ser melhor." },
      { question: "Você pratica atividades físicas?", answer: "Sim, regularmente." },
      { question: "Você sente ansiedade ao pensar em dormir?", answer: "Sim, ocasionalmente." }
    ],
    medicalObservation: "<h1>Orientação para Melhoria do Sono</h1> <h2>Diagnóstico Atual</h2> <p>Com base nas suas respostas, aqui está uma análise detalhada e algumas orientações para melhorar a qualidade do seu sono:</p> <ul> <li><strong>Você tem dificuldade para dormir à noite:</strong> Sim, frequentemente.</li> <li><strong>Quanto tempo você demora para adormecer:</strong> 30 minutos em média.</li> <li><strong>Você sente cansaço durante o dia:</strong> Sim, frequentemente.</li> <li><strong>Você acorda várias vezes durante a noite:</strong> Sim, algumas vezes.</li> <li><strong>Você consome cafeína à tarde ou noite:</strong> Sim, frequentemente.</li> <li><strong>Você tem hábitos relaxantes antes de dormir:</strong> Sim, leitura leve ou meditação.</li> <li><strong>Você utiliza dispositivos eletrônicos antes de dormir:</strong> Sim, frequentemente.</li> <li><strong>Você sente que o ambiente do quarto é adequado para dormir:</strong> Não, pode ser melhor.</li> <li><strong>Você pratica exercícios físicos durante o dia:</strong> Sim, regularmente.</li> <li><strong>Você já experimentou técnicas de higiene do sono:</strong> Sim, mas sem resultados significativos.</li> </ul> <h2>Orientações para Melhorar o Sono</h2> <ul> <li><strong>Evite Cafeína à Noite:</strong> Reduza ou elimine o consumo de cafeína no final da tarde e à noite, pois ela pode interferir no seu sono.</li> <li><strong>Estabeleça uma Rotina de Sono:</strong> Tente ir para a cama e acordar no mesmo horário todos os dias para regular seu ciclo de sono.</li> <li><strong>Crie um Ambiente Propício para Dormir:</strong> Certifique-se de que seu quarto está escuro, silencioso e a uma temperatura confortável. Considere o uso de máscaras de dormir ou tampões de ouvido se necessário.</li> <li><strong>Limite o Uso de Dispositivos Eletrônicos:</strong> Evite o uso de dispositivos eletrônicos pelo menos uma hora antes de dormir. A luz azul emitida por essas telas pode atrapalhar a produção de melatonina.</li> <li><strong>Pratique Técnicas de Relaxamento:</strong> Continue com práticas de leitura leve ou meditação antes de dormir para ajudar seu corpo a relaxar.</li> <li><strong>Considere Consultar um Especialista:</strong> Se as dificuldades persistirem, pode ser útil consultar um especialista em sono para orientação adicional.</li> </ul> <h2>Conclusão</h2> <p>Implementar essas mudanças pode levar algum tempo, mas persistir com elas pode melhorar significativamente a qualidade do seu sono.</p>",
    video: 'https://www.youtube.com/embed/fzYdk1zIpPo?si=5qj7B1w_Vwrw8iK7',
  },
  {
    id: 5,
    title: "Formulário de Questionário de Sono 5",
    shortDescription: "Análise de qualidade do sono e fatores que afetam o descanso.",
    questions: [
      { question: "Você utiliza eletrônicos antes de dormir?", answer: "Sim, frequentemente." },
      { question: "Você sente cansaço ao acordar?", answer: "Sim, frequentemente." },
      { question: "Você tem dificuldade em adormecer?", answer: "Sim, frequentemente." },
      { question: "Você consome cafeína após o almoço?", answer: "Sim, frequentemente." },
      { question: "Você se sente ansioso antes de dormir?", answer: "Sim, frequentemente." },
      { question: "Você tem uma rotina relaxante à noite?", answer: "Não, falha em implementar." },
      { question: "Você utiliza técnicas de relaxamento?", answer: "Sim, mas sem sucesso." },
      { question: "Você tem um ambiente propício para o sono?", answer: "Não, a iluminação pode ser ajustada." },
      { question: "Você pratica exercícios físicos?", answer: "Sim, ocasionalmente." },
      { question: "Você já procurou ajuda profissional?", answer: "Sim, mas sem efeitos duradouros." }
    ],
    medicalObservation: "<h1>Orientação para Melhoria do Sono</h1> <h2>Diagnóstico Atual</h2> <p>Com base nas suas respostas, aqui está uma análise detalhada e algumas orientações para melhorar a qualidade do seu sono:</p> <ul> <li><strong>Você tem dificuldade para dormir à noite:</strong> Sim, frequentemente.</li> <li><strong>Quanto tempo você demora para adormecer:</strong> 30 minutos em média.</li> <li><strong>Você sente cansaço durante o dia:</strong> Sim, frequentemente.</li> <li><strong>Você acorda várias vezes durante a noite:</strong> Sim, algumas vezes.</li> <li><strong>Você consome cafeína à tarde ou noite:</strong> Sim, frequentemente.</li> <li><strong>Você tem hábitos relaxantes antes de dormir:</strong> Sim, leitura leve ou meditação.</li> <li><strong>Você utiliza dispositivos eletrônicos antes de dormir:</strong> Sim, frequentemente.</li> <li><strong>Você sente que o ambiente do quarto é adequado para dormir:</strong> Não, pode ser melhor.</li> <li><strong>Você pratica exercícios físicos durante o dia:</strong> Sim, regularmente.</li> <li><strong>Você já experimentou técnicas de higiene do sono:</strong> Sim, mas sem resultados significativos.</li> </ul> <h2>Orientações para Melhorar o Sono</h2> <ul> <li><strong>Evite Cafeína à Noite:</strong> Reduza ou elimine o consumo de cafeína no final da tarde e à noite, pois ela pode interferir no seu sono.</li> <li><strong>Estabeleça uma Rotina de Sono:</strong> Tente ir para a cama e acordar no mesmo horário todos os dias para regular seu ciclo de sono.</li> <li><strong>Crie um Ambiente Propício para Dormir:</strong> Certifique-se de que seu quarto está escuro, silencioso e a uma temperatura confortável. Considere o uso de máscaras de dormir ou tampões de ouvido se necessário.</li> <li><strong>Limite o Uso de Dispositivos Eletrônicos:</strong> Evite o uso de dispositivos eletrônicos pelo menos uma hora antes de dormir. A luz azul emitida por essas telas pode atrapalhar a produção de melatonina.</li> <li><strong>Pratique Técnicas de Relaxamento:</strong> Continue com práticas de leitura leve ou meditação antes de dormir para ajudar seu corpo a relaxar.</li> <li><strong>Considere Consultar um Especialista:</strong> Se as dificuldades persistirem, pode ser útil consultar um especialista em sono para orientação adicional.</li> </ul> <h2>Conclusão</h2> <p>Implementar essas mudanças pode levar algum tempo, mas persistir com elas pode melhorar significativamente a qualidade do seu sono.</p>",
    video: 'https://www.youtube.com/embed/fzYdk1zIpPo?si=5qj7B1w_Vwrw8iK7',
  }
...
export const chatMock = [
  ...
  { question: "Você sente cansaço durante o dia?", answer: "Sim, frequentemente." },
  { question: "Você acorda várias vezes durante a noite?", answer: "Sim, várias vezes." },
  { question: "Sente sonolência durante o dia?", answer: "Sim, regularmente." },
  { question: "Você tem hábitos relaxantes antes de dormir?", answer: "Sim, leitura leve ou meditação." },
  { question: "Como você avalia a qualidade do seu sono?", answer: "Não está boa, com frequência." },
  { question: "Você já tentou técnicas de relaxamento?", answer: "Sim, uso técnicas como respiração profunda." },
  { question: "Você utiliza dispositivos eletrônicos antes de dormir?", answer: "Sim, frequentemente." },
  { question: "Como você se sente após uma noite mal dormida?", answer: "Cansado e com falta de energia." }
];